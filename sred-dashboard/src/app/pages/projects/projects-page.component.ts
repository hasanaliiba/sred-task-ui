    ...
    <div class="max-w-7xl mx-auto px-4 py-8 space-y-6">
      <div class="flex items-start justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">Hours and cost per project (full year). Removing one cascades to its hours and invoices.</p>
        </div>
        <button
          type="button"
          (click)="grid.openAdd()"
      ...
      <app-project-grid #grid></app-project-grid>
    </div>
  `,
})
